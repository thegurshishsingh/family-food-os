...
const frames = [15, 50, 120, 200, 300, 400, 550, 650, 750];
for (const f of frames) {
  await renderStill({ composition, serveUrl: bundled, output: `/tmp/f${String(f).padStart(3,'0')}.png`, frame: f, puppeteerInstance: browser });
