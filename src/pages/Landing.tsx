    ...
    <div className="min-h-screen bg-background max-w-full overflow-x-hidden">
      ...
      <footer className="relative mt-12">
        ...
        <div className="relative w-full overflow-hidden bg-primary">
          ...
          />
          {/* Gradient fade into the Deep Moss base */}
          <div
            className="absolute inset-x-0 bottom-0 h-2/3 pointer-events-none"
            style={{
              background:
                "linear-gradient(to bottom, transparent 0%, hsl(var(--primary)/0.2) 40%, hsl(var(--primary)/0.85) 80%, hsl(var(--primary)) 100%)",
            }}
            aria-hidden="true"
          />
        </div>

        {/* Deep Moss base with all link content */}
        <div className="bg-primary text-primary-foreground/90">
          ...
          <div className="container px-4 max-w-5xl pt-10 md:pt-16">
            <h2 className="font-serif font-semibold text-primary-foreground text-3xl md:text-5xl lg:text-6xl leading-tight max-w-3xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-10">
              ...
              <div className="grid grid-cols-2 gap-6 text-sm">
                <div className="space-y-2">
                  <p className="font-semibold text-primary-foreground text-xs uppercase tracking-wider mb-3">Product</p>
                ...
                <div className="space-y-2">
                  <p className="font-semibold text-primary-foreground text-xs uppercase tracking-wider mb-3">Support</p>
                  <a href="mailto:hello@familyfoodOS.com" className="block text-primary-foreground/70 hover:text-accent transition-colors text-xs">Contact us</a>
                  <a href="#faq" className="block text-primary-foreground/70 hover:text-accent transition-colors text-xs">FAQ</a>
                  <a href="#" className="block text-primary-foreground/70 hover:text-accent transition-colors text-xs">About</a>
                </div>
              </div>

              {/* Legal + trust */}
              <div className="space-y-2">
                <p className="font-semibold text-primary-foreground text-xs uppercase tracking-wider mb-3">Legal</p>
                <a href="#" className="block text-primary-foreground/70 hover:text-accent transition-colors text-xs">Privacy Policy</a>
                <a href="#" className="block text-primary-foreground/70 hover:text-accent transition-colors text-xs">Terms of Service</a>
                <p className="text-[11px] text-sage-light/80 pt-3">
                  Your family's data is never sold. Ever.
                </p>
              </div>
            </div>

            <div className="border-t border-primary-foreground/15 pt-5 flex flex-col sm:flex-row items-center justify-between gap-2">
