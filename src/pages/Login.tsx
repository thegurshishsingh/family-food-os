...
const Login = () => {
  useDocumentHead({
    title: "Log in — Family Food OS",
    description: "Log in to your Family Food OS account to view this week's dinner plan, grocery list, and family meal history.",
    canonical: "/login",
  });
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background px-4">
      <div className="w-full max-w-sm">
        ...
        <Button variant="outline" className="w-full mb-3 h-11" onClick={handleGoogleLogin}>
        ...
        <Button variant="outline" className="w-full mb-6 h-11" onClick={handleAppleLogin}>
