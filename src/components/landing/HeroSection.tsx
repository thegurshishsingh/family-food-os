  ...
  return (
    <section className="pt-24 pb-2 md:pt-28 md:pb-4 px-4 relative gradient-mesh">
      ...
      <div className="container max-w-6xl mx-auto relative z-10">
        <div className="grid md:grid-cols-[1fr,auto] gap-6 md:gap-10 items-center">
          {/* Left — Copy */}
          <motion.div
          ...
          <motion.div
            ...
            className="relative flex items-center justify-center w-full md:w-[420px]"
          >
            ...
            <motion.div
              className="absolute -left-4 md:-left-14 top-[8%] z-20 hidden md:block"
            ...
            <motion.div
              className="absolute -right-6 md:-right-14 bottom-[20%] z-20 hidden md:block"
              initial={{ opacity: 0, x: 20, scale: 0.95 }}
              animate={{ opacity: 1, x: 0, scale: 1 }}
